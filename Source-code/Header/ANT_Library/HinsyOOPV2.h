...
*/
#ifndef ____HINSYOOPV2_H____ 
#define ____HINSYOOPV2_H____
//////////////////////////////////////////////////////////////////////////////////
//------------------------------------
#include<windows.h>
...
namespace HinsyOOP /* Start of Namespace */
{
	...
	class Hinput {
		protected:
			...
			static char* hidePassword(char* charArray, UINT16 size);
			...
			static string hidePassword(string&  std_string, UINT16 size);
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//#1
void HinsyOOP::H::foreColor(DWORD color_code)
{
	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), color_code|FOREGROUND_INTENSITY);		
}
// #2
void HinsyOOP::H::setConsoleTitle( LPCTSTR  title)
{
...
//----------------------------------------------------------------------
char* HinsyOOP::HLVInput::inputAll(char* charArray, UINT16 size)
{	
	while(true)
	{
		if(strcmp(Hinput::inputAll(charArray, size), "\0") == 0) continue;
		else break;
	}
	
	return charArray;
}
char* HinsyOOP::HLVInput::inputNumber(char* charArray, UINT16 size)
{
	while(true)
	{
		if(strcmp(Hinput::inputNumber(charArray, size), "\0") == 0) continue;
		else break;
	}
	
	return charArray;
}
char* HinsyOOP::HLVInput::inputLetter(char* charArray, UINT16 size)
{
	while(true)
	{
		if(strcmp(Hinput::inputLetter(charArray, size), "\0") == 0) continue;
		else break;
	}
	
	return charArray;
}
char* HinsyOOP::HLVInput::hidePassword(char* charArray, UINT16 size)
{
	while(true)
	{
		if(strcmp(Hinput::hidePassword(charArray, size), "\0") == 0) continue;
		else break;
	}
	
	return charArray;
}
char* HinsyOOP::HLVInput::input4Tel(char* charArray, UINT16 size)
{
	while(true)
	{
		if(strcmp(Hinput::input4Tel(charArray, size), "\0") == 0) continue;
		else break;
	}
...
//----------------------------------------------------------------------
string HinsyOOP::HLVInput::inputAll(string&  std_string, UINT16 size)
{
	while(true)
	{
		if(Hinput::inputAll(std_string, size) == "\0") continue;
		else break;
	}
	
	return std_string;
}
string HinsyOOP::HLVInput::inputNumber(string&  std_string, UINT16 size)
{
	while(true)
	{
		if(Hinput::inputNumber(std_string, size) == "\0") continue;
		else break;
	}
	
	return std_string;
}
string HinsyOOP::HLVInput::inputLetter(string&  std_string, UINT16 size)
{
	while(true)
	{
		if(Hinput::inputLetter(std_string, size) == "\0") continue;
		else break;
	}
	
	return std_string;
}
string HinsyOOP::HLVInput::hidePassword(string&  std_string, UINT16 size)
{
	while(true)
	{
		if(Hinput::hidePassword(std_string, size) == "\0") continue;
		else break;
	}
	
	return std_string;
}
string HinsyOOP::HLVInput::input4Tel(string&  std_string, UINT16 size)
{
	while(true)
	{
		if(Hinput::input4Tel(std_string, size) == "\0") continue;
		else break;
	}
...
// Char Array
//----------------------------------------------------------------------
char* HinsyOOP::Hinput::inputAll(char* charArray, UINT16 size)
{
	char input;
	int index = 0;
	while(1)
...
////////////////////////////////////////
char* HinsyOOP::Hinput::inputNumber(char* charArray, UINT16 size)
{
	char input;
	int index = 0;
...
////////////////////////////////////////
char* HinsyOOP::Hinput::inputLetter(char* charArray, UINT16 size)
{
	char input;
	int index = 0;
...
////////////////////////////////////////
char* HinsyOOP::Hinput::hidePassword(char* charArray, UINT16 size)
{
	char input;
	int index = 0;
...
////////////////////////////////////////
char* HinsyOOP::Hinput::input4Tel(char* charArray, UINT16 size)
{
	char input;
	int index = 0;
...
// std::string 
//----------------------------------------------------------------------
string HinsyOOP::Hinput::inputAll(string&  std_string, UINT16 size)
{
	char input;
	std_string = "";
...
////////////////////////////////////////
string HinsyOOP::Hinput::inputNumber(string&  std_string, UINT16 size)
{
	char input;
	std_string = "";
...
////////////////////////////////////////
string HinsyOOP::Hinput::inputLetter(string&  std_string, UINT16 size)
{
	char input;
	std_string = "";
...
////////////////////////////////////////
string HinsyOOP::Hinput::hidePassword(string&  std_string, UINT16 size)
{
	char input;
	std_string = "";
...
////////////////////////////////////////
string HinsyOOP::Hinput::input4Tel(string& std_string, UINT16 size)
{
	char input;
	std_string = "";
